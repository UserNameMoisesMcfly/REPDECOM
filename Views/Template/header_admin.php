...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <meta name="description" content="REPDECOM">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Moises Gomez">
    <meta name="theme-color" content="#A93226">
    <link rel="shortcut icon" href="<?=media();?>/images/camera.ico">
  ...
  <body class="app sidebar-mini">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="<?=base_url(); ?>/dashboard">REP-ADMIN</a>
