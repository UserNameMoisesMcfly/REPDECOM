<?php
    ...
    class Usuarios extends Controllers{
        ...
        public function Usuarios(){
            ...
            $data['page_title']="USUARIOS <small>REPDECOM</small>";
        ...
        public function getUsuarios(){
			...
			for ($i=0; $i < count($arrData); $i++) {
				...
				$arrData[$i]['options'] = '<div class="text-center">
                                            ...
                                            <button class="btn btn-info btn-sm btnViewUsuario" us="'.$arrData[$i]['idpersona'].'" title="Ver Usuario"><i class="fas fa-key"></i></button>
